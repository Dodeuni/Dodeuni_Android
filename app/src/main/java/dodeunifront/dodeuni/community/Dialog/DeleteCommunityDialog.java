...
public class DeleteCommunityDialog extends Dialog implements View.OnClickListener {
        private CustomDialogInterface customDialogInterface;
        private Context context;
        private Button mDlgOkBtn, mDlgNoBtn;
        public String mBtnName;

        public DeleteCommunityDialog(@NonNull Context context) {
                super(context);
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.dialog_deletecommunity);

                mDlgOkBtn = findViewById(R.id.btn_delete_ok);
                mDlgNoBtn = findViewById(R.id.btn_delete_cancel);
