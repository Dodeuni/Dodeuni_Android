...
import dodeunifront.dodeuni.community.Dialog.CustomDialogInterface;

public class PostCommunityDialog extends Dialog implements View.OnClickListener {
    private CustomDialogInterface customDialogInterface;
    private Context context;
    private Button mDlgOkBtn, mDlgNoBtn;
    public String mBtnName;

    public PostCommunityDialog(@NonNull Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_postcommunity);

        mDlgOkBtn = findViewById(R.id.btn_post_ok);
        mDlgNoBtn = findViewById(R.id.btn_post_cancel);
